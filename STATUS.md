...
7. 7. MBTiles server | :cloud: | `tessera` | | Yes
...
----------- | --------- | ------ | ----- | ----- | ------ |  --------
1. PBF Extract | :hand: | :bomb: | Can be done directly or using the [HOT Export Tool](http://export.hotosm.org/) with an arbitrary file format | | | Yes
1a. Overpass → XML | :hand: | :bomb: | | | |  Yes
1b. XML → PBF conversion | :hand: | :bomb: | Osmosis | | |  Yes
2. MBTiles creation | :hand: | :bomb: | [tl](https://github.com/mojodna/tl) or [mbtiles-generate](https://github.com/AmericanRedCross/mbtiles-generate) (which uses `tl` internally) | | [tl#15](https://github.com/mojodna/tl/issues/15) | Yes

### Outputs

Description | Status | Notes | Owner | For Ecuador
----------- | ------ | ----- | ----- | ------
1. AOI data package | :bomb: | HTTP-accessible, contains PBF + MBTiles (styles TBD) for the AOI | | Yes

## Initial Device Data Provisioning

Description | Automated | Status | Notes | Owner | For Ecuador
----------- | --------- | ------ | ----- | ----- | ---------
1. Download data package | :hand: | :bomb: | Target path: **TBD** | | Yes
2. Extract MBTiles | :hand: | :cloud: | Target path: **TBD** | | Yes
3. Extract PBF | :hand: | :cloud: | Target path: **TBD** | | Yes
4. Populate APIDB<sup>1</sup> | :hand: | :bomb: | Osmosis | | Yes
5. Populate rendering DB | :hand: | :cloud: | `osm2pgsql` | | Maybe
6. Restart tile server(s) | :hand: | :cloud: | | | Yes
...
Description | Status | Notes | Owner | For Ecuador
----------- | ------ | -----| ----- | -------
1. HTTP-accessible tiles | :cloud: | From MBTiles archive(s) | | Maybe
...
4. Trace in iD | :hand: | :bomb: | static iD, fp-tiler | | Yes
...
3. HTTP-accessible snapshot tiles | :bomb: | `fp-tiler` | | [fieldpapers#202](https://github.com/fieldpapers/fieldpapers/issues/202) | Yes
